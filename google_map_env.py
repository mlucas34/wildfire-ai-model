...
# TICK_SECONDS = 0.5  # how often the page will request a step
# # ====================
...
# @app.get("/")
# def index():
#     return render_template("index.html", key=GMAPS_JS_API_KEY)
...
# ===== Paths =====
ICON_DIR = "/Users/tartmsu/Desktop/wildfire-ai-model/img"  # your real PNG folder
